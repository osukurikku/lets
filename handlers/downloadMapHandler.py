...
class handler(requestsManager.asyncRequestHandler):
    ...
    def asyncGet(self, bid):
        try:
            ...
            url = "https://chimu.moe/d/{}{}".format(bid, "?n=1" if noVideo else "")
    ...
    def asyncGet(self, megaepic):
        try:
            ...
            if len(arguments) < 3:
                ...
                url = "https://chimu.moe/d/{}{}".format(arguments[0], "?n=1" if noVideo else "")

            if len(arguments) == 3:
                noVideo = megaepic.endswith("n")
                url = "https://chimu.moe/d/{}{}".format(arguments[2], "?n=1" if noVideo else "")
